...
public class EncodeAndMuxTest {
    ...
    public void testEncodeVideoToMp4() {
        ...
        try {
            ...
            for (int i = 0; i < NUM_FRAMES; i++) {
                // Feed any pending encoder output into the demuxerVideo.
                drainEncoder(false);
            ...
            // release encoder, demuxerVideo, and input Surface
            releaseEncoder();
        }
    ...
    /**
     * Configures encoder and demuxerVideo state, and prepares the input Surface.
     */
    private void prepareEncoder() throws IOException {
        ...
        // Create a MediaMuxer.  We can't add the video track and start() the demuxerVideo here,
     ...
     * Calling this with endOfStream set should be done once, right before stopping the demuxerVideo.
     */
    private void drainEncoder(boolean endOfStream) {
        ...
        while (true) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                // now that we have the Magic Goodies, start the demuxerVideo
                ...
                if ((mBufferInfo.flags & MediaCodec.BUFFER_FLAG_CODEC_CONFIG) != 0) {
                    // The codec config data was pulled out and fed to the demuxerVideo when we got
                ...
                if (mBufferInfo.size != 0) {
                    if (!mMuxerStarted) {
                        throw new RuntimeException("demuxerVideo hasn't started");
                    }
                    ...
                    if (VERBOSE) Log.d(TAG, "sent " + mBufferInfo.size + " bytes to demuxerVideo");
                }
